...
const Photos = () => {
  ...
  //this functionn handles adding photos to the movie
...
//functions that fetch photos from database or api
  ...
  //edit or update the photo functonality
...
//clear function
  ...
  //functions all return here output of a program
  return (
